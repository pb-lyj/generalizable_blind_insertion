...
from diffusion_policy.model.vision.multi_tactile_obs_encoder import (
    MultiTactileObsEncoder,
)
from diffusion_policy.common.pytorch_util import dict_apply


class DiffusionUnetTactilePolicy(BaseImagePolicy):
    def __init__(
        self,
        shape_meta: dict,
        noise_scheduler: DDPMScheduler,
        obs_encoder: MultiTactileObsEncoder,
        horizon,
        n_action_steps,
        n_obs_steps,
